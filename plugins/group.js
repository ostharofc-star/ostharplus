...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, isAdmins, reply, participants, quoted, args }) => {
  if (!isGroup || !isAdmins) 
  ...
  await OSTHAR.groupParticipantsUpdate(m.chat, [target], "remove");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, isAdmins, reply, participants }) => {
...
cmd({
  ...
  category: "group",
  filename: __filename
}, async (OSTHAR, mek, m, { isGroup, isAdmins, reply, participants, args, quoted }) => {
  if (!isGroup) return reply("❌ This command can only be used in groups!");
  ...
  try {
    ...
    await OSTHAR.updateProfilePicture(m.chat, media);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, reply, participants }) => {
...
async (OSTHAR, mek, m, { from, isGroup, isAdmins, reply, args }) => {
    try {
        ...
        await OSTHAR.groupParticipantsUpdate(from, [target], "add");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, isAdmins, reply, quoted, args }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");
  ...
  await OSTHAR.groupParticipantsUpdate(m.chat, [target], "promote");
...
cmd({
  ...
  await OSTHAR.groupParticipantsUpdate(m.chat, [target], "demote");
...
async (OSTHAR, mek, m, { from, isGroup, isAdmins, reply }) => {
    try {
        if (!isGroup) return reply("⚠️ This command can only be used in a group!");
        if (!isAdmins) return reply("⚠️ This command is only for group admins!");

        await OSTHAR.groupSettingUpdate(from, "not_announcement");
...
async (OSTHAR, mek, m, { from, isGroup, isAdmins, reply }) => {
    try {
        ...
        await OSTHAR.groupSettingUpdate(from, "announcement");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, isAdmins, reply }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");

  await OSTHAR.groupRevokeInvite(m.chat);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, reply }) => {
  if (!isGroup) 
    return reply("*Group only & I must be an admin.*");

  const code = await OSTHAR.groupInviteCode(m.chat);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (OSTHAR, mek, m, { isGroup, isAdmins, args, reply }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");

  if (!args[0]) return reply("*Give a new group name.*");

  await OSTHAR.groupUpdateSubject(m.chat, args.join(" "));
...
cmd({
  ...
  await OSTHAR.groupUpdateDescription(m.chat, args.join(" "));
...
cmd({
  ...
  const metadata = await OSTHAR.groupMetadata(m.chat);
